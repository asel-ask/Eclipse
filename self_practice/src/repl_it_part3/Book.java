	 ...
	 */
	    ...
	    public static String capitalize(String word) {
	    	...
	    	if(word.isEmpty()) {
	    		...
	    		for(String foreach : arr) {
	    			result +=foreach.substring(0,1).toUpperCase().concat(foreach).substring(1).toLowerCase()+" ";
	    		}
			  result=result.trim();
	    ...
	    /**
	      ...
	      - The method returns false => if word parameter is one of articles, 
	      coordinate conjunctions, or prepositions. See full list below
	    ...
	    public static Boolean isTitleWord(String word) {
			...
			String [] arr= {"a","an","the","and","but","for","nor","or","so","yet","at","by",
