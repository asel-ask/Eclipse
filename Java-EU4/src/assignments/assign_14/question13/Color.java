package assignments.assign_14.question13;
import java.util.*;
public class Color {
	  ...
	  *    * assign 3 int parameters to rgb array indexes(0,1,2)    
	      ...
	      * @param g   
	      * @param b     */   
	 public Color(int r, int g, int b){       //TODO    
		 rgb[0]=r;
		 rgb[1]=g;
		 rgb[2]=b;
	 }
   ...
   *  * and find out what color it is.
   Arrays.equals(arr1,arr2) is easiest way    
    * to compare 2 int arrays    
    * @returns a String 
   color name like     * "white" or "blue"   If rgb values does not match any available 
