...
public class primitiveVariables {
	...
	public static void main(String[] args) {
		...
		long l1=5000; //suffix L is optional.
	
		long l2=-2147483649L; //suffix L is mandatory
		...
		//floating numbers: default is double
		 ...
		 System.out.println("Eligible to take the exam = "+status2);
		 
		 
		 String name= "ozzy";
		 
		 System.out.println("His names is "+name);
